...
// Render Uptime Port Dinleyici (Crash Engelleme)
...
// Hataların Botu Düşürmesini Engelleme (Global Error Catch)
...
client.login(process.env.TOKEN).catch(err => {
    console.error("❌ BOT LOGIN HATASI: TOKEN geçersiz veya Discord yetkilendirme hatası!", err);
});
